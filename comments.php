...
<<<<<<< HEAD
        <h2 class="comments-title">
            <?php
            //printf( _n( '1 条评论', '%1$s 条评论 &ldquo;%2$s&rdquo;', get_comments_number(), 'unnuo' ),
        ...
        <?php if (!comments_open()) : ?>
            <p class="no-comments"><?php _e('Comments are closed.', 'unnuo'); ?></p>
        <?php endif; ?>
=======
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform"
            ...
            <?php else : ?>
                <p class="user_info">
                    ...
                    <input type="email" name="email" id="email_input" value="<?php echo $comment_author_email; ?>"
                           size="22" tabindex="2" placeholder="邮箱（必填）"/>
                    <input type="url" name="url" id="url_input" value="<?php echo $comment_author_link; ?>" size="22"
                           tabindex="2" placeholder="网址（选填）"/>
                </p>
            <?php endif; ?>
            <p class="user_text">
...
=======
	...
	<?php else : ?>
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" class="commentform" name="commentform">
